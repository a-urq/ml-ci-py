# ml-ci-py
A machine learning model made to predict the probability of convective initiation within a 2-hour lead time model, using RAP environmental parameters for predictors.
